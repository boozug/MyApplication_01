...
//        Create Observable
        ConnectableObservable<List<Ticket>> ticketsObservable = getTickets(to).replay();
     ...
     */
    private Observable<List<Ticket>> getTickets(String to) {
        return apiService.searchTickets(MainActivity.from, to)
                .toObservable()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
